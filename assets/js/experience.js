...
const exp = [
  {
    ...
    cardImage: "assets/images/experience-page/fiverr.jpg",
    place: "Fiverr",
    time: "(June 2024 - present)",
    desp: "<li>Providing freelance software development services through Fiverr, working on a range of web and mobile application projects.</li> <li>Expert in JavaScript, React, Node.js, and other modern web technologies to deliver high-quality solutions.</li> <li>Collaborated with clients to build custom applications, integrate APIs, and implement design features to meet business needs.</li> <li>Consistently received positive feedback for timely delivery, clear communication, and effective problem-solving.</li>",
},

{
  title: "Freelance Software Developer",
  cardImage: "assets/images/experience-page/upwork.jpg",  // Use an appropriate image for Upwork work
  place: "Upwork",
